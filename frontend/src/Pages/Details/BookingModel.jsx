...
const guestRegularFee=property?.prices?.guestsIncludedInRegularFee*quote?.rates?.ratePlans[0]?.days[0]?.price
const extraPersonFee=(property?.prices?.extraPersonFee+property?.prices?.guestsIncludedInRegularFee)*quote?.rates?.ratePlans[0]?.days[0]?.price
console.log(guestRegularFee,extraPersonFee)
const finalPrice=guestRegularFee+extraPersonFee
const discountAmount=quote?.promotions?.name?quote?.rates?.ratePlans[0]?.ratePlan?.money?.invoiceItems[1]?.amount:0
